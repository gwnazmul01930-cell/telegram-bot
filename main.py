    ...
    if not user_data["is_active"] and not user_is_admin:
        ...
        if p_status == "Pending":
            text = (
                ...
                f"অ্যাডমিন চেক করার সাথে সাথেই আপনার অ্যাকাউন্টটি **সক্রিয় (Active)** করে দেওয়া হবে। দয়া করে একটু অপেক্ষা করুন।"
            )
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """ইউজার যখন পেমেন্ট করার পর TrxID চ্যাটে লিখে পাঠাবে তখন এটি কাজ করবে"""
    user = update.effective_user
    user_id = user.id
    init_user(user_id, user.first_name)
    user_data = users_db[user_id]
    
    # যদি ইউজার ইনঅ্যাক্টিভ থাকে এবং সে টেক্সট মেসেজ দেয় (ধরে নিচ্ছি সেটি TrxID)
...
def main():
    ...
    # সাধারণ টেক্সট মেসেজ হ্যান্ডলার (ইউজারদের পাঠানো TrxID ধরার জন্য)
