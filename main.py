...
# আপনার টেলিগ্রাম আইডি এখানে বসিয়ে দিন (যাতে শুধু আপনিই অ্যাডমিন প্যানেল দেখতে পান)
ADMIN_IDS = [@nasmul01930]  # <--- আপনার আসল টেলিগ্রাম আইডি এখানে দিন
...
def init_user(user_id, name):
    if user_id not in users_db:
        users_db[user_id] = {
            "name": name,
            "balance": 0.0,
            "is_active": False,  # অ্যাকাউন্ট প্রথমে ইনঅ্যাক্টিভ থাকবে
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.args:
        try:
            ...
            if inviter_id in users_db and users_db[user_id]["referred_by"] is None and inviter_id != user_id:
                ...
                # শুধুমাত্র ইনভাইটার একটিভ থাকলেই লেভেল কমিশন যোগ হবে
    ...
    # যদি অ্যাকাউন্ট ইনঅ্যাক্টিভ থাকে এবং ইউজার অ্যাডমিন না হয়
    if not user_data["is_active"] and user_id not in ADMIN_IDS:
        keyboard = [
    ...
    # সিকিউরিটি: শুধু আপনার স্ক্রিনেই অ্যাডমিন প্যানেল বাটন দেখাবে
    ...
    welcome_text = (
        ...
        f"  🥉 **Level 3:** ৳৫০ (আপনার লেভেল ২ এর ব্যক্তি যাকে করবে)\n"
        f"  🏅 **Level 4:** ৳৫০ (আপনার লেভেল ৩ এর ব্যক্তি যাকে করবে)\n\n"
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "pay_activate":
        ...
        text = (
            ...
            f"━━━━━━━━━━━━━━━━━━━━━━\n"
            f"🥇 **Level 1 (যাকে আপনি নিজে রেফার করবেন):** ৳{inc[1]:.2f}\n"
            f"🥈 **Level 2 (আপনার রেফারকৃত ব্যক্তি যাকে করবে):** ৳{inc[2]:.2f}\n"
            f"🥉 **Level 3 (আপনার লেভেল ২ এর ব্যক্তি যাকে করবে):** ৳{inc[3]:.2f}\n"
            f"🏅 **Level 4 (আপনার লেভেল ৩ এর ব্যক্তি যাকে করবে):** ৳{inc[4]:.2f}\n"
            f"━━━━━━━━━━━━━━━━━━━━━━\n"
        ...
        if user_data["balance"] >= 500.0:
            ...
            user_data["balance"] = 0.0  # উইথড্র রিকোয়েস্টের পর ব্যালেন্স শূন্য করা হলো
            text = (
    ...
    elif query.data == "list_inactive" and user_id in ADMIN_IDS:
    ...
    elif query.data.startswith("activate_") and user_id in ADMIN_IDS:
