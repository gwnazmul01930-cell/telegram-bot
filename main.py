...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # রেফারেল হ্যান্ডলিং (যদি নতুন ইউজার হয় এবং আগে কেউ রেফার না করে থাকে)
    ...
    if query.data == "pay_activate":
        ...
        if target_user and not target_user["is_active"]:
            ...
            if l1_id:
                ...
                if l1_user and l1_user["is_active"]:
                            ...
                            if l3_id:
                                ...
                                if l3_user and l3_user["is_active"]:
                                    ...
                                    if l4_id:
                                        ...
                                        if l4_user and l4_user["is_active"]:
            ...
            try:
                await context.bot.send_message(
                    chat_id=target_uid,
                    text="🎉 **অভিনন্দন!** আপনার অ্যাকাউন্টটি সফলভাবে **Active** করা হয়েছে!",
                    parse_mode="Markdown"
                )
            except Exception:
                pass
